...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>PHP 3th Part - Exo 3</title>
  ...
  <!--Let browser know website is optimized for mobile-->
    ...
    <body>
        <div>
            ...
            <div class="container">
            <div class="row center"><div class="col l6 green-text ">Des strings à en chier par terre !</div>
                <div class="col l6 red-text"><?php
        function Returnstring($string)
                {
                echo $string.' | ';
        }
        Returnstring('ceci est une chaine de caract');
        Returnstring('mes couille sur ton front ça fait des rayban');
        Returnstring('Et le pire est, elle adore ça !');
