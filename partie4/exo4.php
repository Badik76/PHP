...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>PHP 3th Part - Exo 4</title>
  ...
  <!--Let browser know website is optimized for mobile-->
    ...
    Les deux nombres sont identiques si les deux nombres sont égaux</p>
        ...
        function comparatenumber($number1, $number2)
                {
                if ($number1 > $number2) {
                    echo $number1.' est plus grand que tout';
                } else if ($number1 < $number2) {
                    echo $number1.' est ridicule à coté de '.$number2;
                } else {
                    echo 'les deux nombres sont identiques maggle !';
                }
        }
