...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>PHP 7th Part - Exo 7</title>
    ...
    <body>
        <div>
            ...
            <p>Avec le formulaire de l'exercice 5, <br />
                Si des données sont passées en POST ou en GET, le formulaire ne doit pas être affiché.<br />
                Par contre les données transmises doivent l'être.<br />
