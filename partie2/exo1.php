...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>PHP 2nd Part - Exo 1</title>
...
Si l'âge est supérieur ou égale à 18, afficher Vous êtes majeur. <br /> Dans le cas contraire, afficher Vous êtes mineur.</p>
            <div class="container">
            <div class="row center"><div class="col l6 green-text ">Majeur ou Mineur : </div>
