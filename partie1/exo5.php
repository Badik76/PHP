...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>PHP 1st Part - Exo 5</title>
...
Donner une valeur à cette variable et l'afficher</p>
            <div class="container">
            <div class="row center"><div class="col l6 green-text ">J'affiche ma variable "int" = rien </div>
                <div class="col l6 red-text"><?php
        $int = "rien";
        echo $int;
        ?></div></div>
                <div class="row "><div class="col l6 green-text center">J'affiche ma variable "int" avec une valeur</div>
