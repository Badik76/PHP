  ...
  <!--Let browser know website is optimized for mobile-->
    ...
    <body>
        <div>
            ...
            <p>Créer trois variables lastname , firstname et age <br /> et les initialiser avec les valeurs de votre choix. Attention age est de type entier.
<br /> Afficher : "Bonjour" + lastname + firstname + ",tu as" + age + "ans".</p>
        ...
        $lastname = "Hitler";
        $age = 70;
        echo "Salut $name $lastname, ça gaz ? Tu as bien $age ans !";
        ?></div>
            </div>              
            </div>
        </div>
